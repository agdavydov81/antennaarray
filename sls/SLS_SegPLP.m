function [segments, dist_raw, dist_filt, dist_norm, dist_time]=SLS_SegPLP(file)
    global seg_config;
    ...
    [~, ~, spec_time, spec_] = spectrogram(file.x, samples_window, samples_overlap, fft_size, file.fs);
    spec_ = rm_audspec(spec_, file.fs, 18, 'bark', rm_bark2hz(1), rm_bark2hz(19), 1, 1);
