function q=vb_importsii(f,m)
%vb_importsii calculates the SII importance function per Hz or per Bark Q=(F,M)
% Inputs:
...
%      Version: $Id: vb_importsii.m,v 1.2 2009/07/26 18:16:28 dmb Exp $
%
