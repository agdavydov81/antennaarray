function [ss,zo]=vb_specsub(si,fsz,pp)
%vb_specsub performs speech enhancement using spectral subtraction [SS,ZO]=(S,FSZ,P)
%
% Inputs:
...
%                   (a) y=vb_specsub(s,fs);
%
%                   (b) [y1,z]=vb_specsub(s(1:1000),fs);
%                       [y2,z]=vb_specsub(s(1001:2000),z);
%                       y3=vb_specsub(s(2001:end),z);
%                       y=[y1; y2; y3];
%
...
%      Version: $Id: vb_specsub.m,v 1.2 2009/02/27 07:46:15 dmb Exp $
%
