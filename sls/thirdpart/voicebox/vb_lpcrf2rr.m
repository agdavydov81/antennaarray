function [rr,ar]=vb_lpcrf2rr(rf,p);
%vb_lpcrr2ar convert reflection coefs to autocorrelation coefs [RR,AR]=(RF,P)
%
...
%      Version: $Id: vb_lpcrf2rr.m,v 1.5 2007/05/04 07:01:39 dmb Exp $
%
