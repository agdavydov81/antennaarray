function d=vb_distitpf(pf1,pf2,mode)
%vb_distitpf calculates the Itakura spectral distance between power spectra D=(PF1,PF2,MODE)
%
...
%
% The Itakura distance is gain-independent, i.e. vb_distitpf(g*pf1,pf2) is independent of g.
...
%      Version: $Id: vb_distitpf.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
