function x=vb_rsfft(y,n)
%vb_rsfft    fft of a real symmetric spectrum X=(Y,N)
...
%      Version: $Id: vb_rsfft.m,v 1.4 2007/05/04 07:01:39 dmb Exp $
%
...
if ~isreal(y) error('vb_rsfft: Input must be real'); end
fl=size(y,1)==1;
if fl y=y(:); end
[m,k]=size(y);
if nargin<2 n=2*m-2;
