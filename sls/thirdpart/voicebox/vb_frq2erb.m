function erb = vb_frq2erb(frq)
%vb_frq2erb  Convert Hertz to ERB frequency scale ERB=(FRQ)
%	erb = vb_frq2erb(frq) converts a vector of frequencies (in Hz)
...
%      Version: $Id: vb_frq2erb.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
