function x=vb_pcmu2lin(p,s)
%vb_pcmu2lin Convert Mu-law PCM to linear X=(P,S)
%	lin = vb_pcmu2lin(pcmu) where pcmu contains a vector
...
%      Version: $Id: vb_pcmu2lin.m,v 1.4 2007/05/04 07:01:39 dmb Exp $
%
