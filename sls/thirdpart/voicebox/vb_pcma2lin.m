function x=vb_pcma2lin(p,m,s)
%vb_pcmu2lin Convert A-law PCM to linear X=(P,M,S)
%	lin = vb_pcma2lin(pcma,m,s) where pcma contains a vector or matrix
...
%      Version: $Id: vb_pcma2lin.m,v 1.4 2007/05/04 07:01:39 dmb Exp $
%
