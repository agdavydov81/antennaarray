function [k,v]=vb_findpeaks(x,m,w)
%vb_findpeaks finds peaks with optional quadratic interpolation [K,V]=(X,M,W)
%
...
%      Version: $Id: vb_findpeaks.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
