function p=vb_lin2pcmu(x,s)
%vb_lin2pcmu Convert linear to Mu-law PCM P=(X,S)
%	pcmu = vb_lin2pcmu(lin) where lin contains a vector
...
%      Version: $Id: vb_lin2pcmu.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
