function [d,fp,dt,tc,t]=vb_readhtk(file)
%vb_readhtk  read an HTK parameter file [D,FP,DT,TC,T]=(FILE)
%
% Input:
...
%             2  LPREFC       LPC Reflection coefficients:  -vb_lpcar2rf([1 LPC]);LPREFC(1)=[];
...
%      Version: $Id: vb_readhtk.m,v 1.8 2007/05/04 07:01:39 dmb Exp $
%
