function [y,fs,h]=vb_readau(filename,mode)
%vb_readau  Read a SUN .AU format sound file [Y,FS,H]=(FILENAME)
%
% Inputs:
...
%      Version: $Id: vb_readau.m,v 1.1 2008/03/27 18:52:41 dmb Exp $
%
