function [y,t]=vb_schmitt(x,thresh,minwid)
% Pass input signal X through a vb_schmitt trigger
% vb_schmitt(X,[LOW HIGH]) gives low and high thresholds. LOW and HIGH can be
% scalars or can be vectors specifiying different thresholds for each X element.
%
% vb_schmitt(X,HYSTERESIS) specifies the thresholds as MAX-DELTA and MIN+DELTA where
...
% For [Y,T]=vb_schmitt(...) Y contains alternate +1 and -1 values and T contains
% the sample numbers at which X crossed the thresholds.


%      Copyright (C) Mike Brookes 1998
%      Version: $Id: vb_schmitt.m,v 1.4 2007/05/04 07:01:39 dmb Exp $
%
