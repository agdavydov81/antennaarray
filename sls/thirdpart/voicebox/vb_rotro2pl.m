function [u,v,t]=vb_rotro2pl(r)
%vb_rotro2pl find the plane and vb_rotation angle of a vb_rotation matrix [u,v,t]=r
% Inputs:
%
...
%     T is the vb_rotation angle in radians from U towards V with 0<=T<=pi. If T
%       is omitted it U and V will be separated by T instead of being orthogonal

%
%      Copyright (C) Mike Brookes 2007
%      Version: $Id: vb_rotro2pl.m,v 1.1 2007/11/24 14:38:29 dmb Exp $
%
...
if nargout>2
    ...
    [s,c]=vb_atan2sc(abs(e(i+1,i)),e(i,i));
    v=uv*[c;s];
end
