function x=vb_choosenk(n,k)
%vb_choosenk All choices of K elements taken from 1:N [X]=(N,K)
...
% V(vb_choosenk(LENGTH(V),K)).

% vb_choosenk(N,K) is the same as the MATLAB5 function NCHOOSEK(1:N,K) but is
% much faster for large N and most values of K.

%   Copyright (c) 1998 Mike Brookes,  mike.brookes@ic.ac.uk
%      Version: $Id: vb_choosenk.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
