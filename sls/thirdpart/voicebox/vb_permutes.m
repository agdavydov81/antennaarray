function [p,s]=vb_permutes(n)
%vb_permutes All N! permutations of 1:N + signatures [P,S]=(N)
...
% V(vb_permutes(LENGTH(V))).

% vb_permutes(N) is the same as SORTROWS(PERMS(1:N)) but much faster.

% Thanks to Peter J Acklam for several improvements.

%      Copyright (c) 1998 Mike Brookes,  mike.brookes@ic.ac.uk
%      Version: $Id: vb_permutes.m,v 1.4 2007/05/04 07:01:39 dmb Exp $
%
