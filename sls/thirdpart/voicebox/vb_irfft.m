function x=vb_irfft(y,n,d)
%vb_irfft    Inverse fft of a conjugate symmetric spectrum X=(Y,N,D)
%
...
% if it is odd.
%
% See also the forward transform: vb_rfft

%      Copyright (C) Mike Brookes 2009
%      Version: $Id: vb_irfft.m,v 1.5 2009/06/03 11:58:37 dmb Exp $
%
