function [t,s]=vb_zerocros(x,m)
%vb_zerocros finds the zeros crossings in a signal [T,S]=(X,M)% find zero crossings in a signal
...
% Example: x=sin(2*pi*(0:1000)/200); x(1:100:1001)=0; vb_zerocros(x);
% Note that we get a zero crossing at the end but not at the start.

%	   Copyright (C) Mike Brookes 2003
%      Version: $Id: vb_zerocros.m,v 1.4 2007/05/04 07:01:39 dmb Exp $
%
