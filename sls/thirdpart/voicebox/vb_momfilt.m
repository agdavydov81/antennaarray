function [y,mm]=vb_momfilt(x,r,w,m)
%vb_momfilt calculates moments of a signal using a sliding window Y=(X,R,W,M)
%
...
%             y=vb_momfilt(x,[2 4],30); k=y(:,2)./y(:,1).^2

%	   Copyright (C) Mike Brookes 2007
%      Version: $Id: vb_momfilt.m,v 1.1 2007/07/18 17:42:13 dmb Exp $
%
