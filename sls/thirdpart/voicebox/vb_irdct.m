function x=vb_irdct(y,n,a,b)
%vb_irdct    Inverse discrete cosine transform of real data X=(Y,N) 
% Data is truncated/padded to length N.
%
% This routine is equivalent to multiplying by the matrix
%
%    vb_irdct(eye(n)) = cos((0.5:n)'*(0:n-1)*pi/n)*diag([sqrt(0.5)*a/b repmat(a,1,n-1)])/n
%
%
...
%      Version: $Id: vb_irdct.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
