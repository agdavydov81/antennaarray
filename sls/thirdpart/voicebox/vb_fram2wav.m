function [w,s]=vb_fram2wav(x,tt,mode)
%vb_fram2wav  converts frame values to a continuous waveform [W]=(X,TT,MODE)
%  Inputs:
...
%      Version: $Id: vb_fram2wav.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
