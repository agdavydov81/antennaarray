function mel = vb_frq2mel(frq)
%vb_frq2erb  Convert Hertz to Mel frequency scale MEL=(FRQ)
%	mel = vb_frq2mel(frq) converts a vector of frequencies (in Hz)
...
%      Version: $Id: vb_frq2mel.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
