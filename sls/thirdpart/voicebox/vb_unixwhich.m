function f=vb_unixwhich(c,e)
%vb_unixwhich Search system path for an executable program [F]=(C,E)
%
...
%
% Notes: (1) This is vb_windows specific and needs to be fixed to work on UNIX systems
%        (2) The search is case insensitive (like most of vb_windows). 
%        (3) The routine does not cache the directory listings so you
%            should avoid doing the same search many times if you care
%            about speed.
%        (4) To include all files that CMD.EXE will search, set e=vb_winenvar('pathext')
%        (5) As well as their normal full-length name, vb_windows files and folders have 
...
%            user and vb_unixwhich, unlike the operating system, will not search for them.

%   Copyright (c) 2005 Mike Brookes,  mike.brookes@ic.ac.uk
%      Version: $Id: vb_unixwhich.m,v 1.3 2007/05/04 07:01:39 dmb Exp $
%
