function d = rm_deltas(x, w)
% D = rm_deltas(X,W)  Calculate the rm_deltas (derivatives) of a sequence
%    Use a W-point window (W odd, default 9) to calculate rm_deltas using a
