% rm_process_options - Processes options passed to a Matlab function.
...
%
%     [u, v] = rm_process_options(varargin, 'u', 0, 'v', 1);
%
...
%   function y = func(x, y, varargin)
%
%     [u, v, unused_args] = rm_process_options(varargin, 'u', 0, 'v', 1);
%
...
function [varargout] = rm_process_options(args, varargin)
