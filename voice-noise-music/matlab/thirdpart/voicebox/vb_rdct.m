function y=vb_rdct(x,n,a,b)
%vb_rdct     Discrete cosine transform of real data Y=(X,N,A,B)
% Data is truncated/padded to length N.
%
% This routine is equivalent to multiplying by the matrix
%
%   vb_rdct(eye(n)) = diag([sqrt(2)*B/A repmat(2/A,1,n-1)]) * cos((0:n-1)'*(0.5:n)*pi/n)
%
...
%
% see vb_irdct for the inverse transform
...
%      Version: $Id: vb_rdct.m,v 1.6 2007/05/04 07:01:39 dmb Exp $
%
