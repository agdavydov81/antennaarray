function [x,g,j,gg] = vb_kmeans(d,k,x0,l)
%vb_kmeans Vector quantisation using K-means algorithm [X,ESQ,J]=(D,K,X0,L)
%
%  Inputs:
%
...
% dimension before calling vb_kmeans.

%  Originally based on a routine by Chuck Anderson, anderson@cs.colostate.edu, 1996


%      Copyright (C) Mike Brookes 1998
%      Version: $Id: vb_kmeans.m,v 1.8 2009/09/13 15:50:12 dmb Exp $
%
