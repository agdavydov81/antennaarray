...
%     Q(3,3)   3x3 vb_rotation matrix
%
% Outputs:
%
%     E(3,1)   3 euler angles
%
% The string M specifies the axes about which the vb_rotations are performed.
...
%      Version: $Id: vb_rotqr2eu.m,v 1.3 2007/11/23 18:47:45 dmb Exp $
%
...
% test: ea=2*pi*(rand(3,1)-0.5);m='yxy';q=vb_roteu2qr(m,ea); e=vb_rotqr2eu(m,q);[[ea*180/pi; 0] [e*180/pi; 0] q vb_roteu2qr(m,e)]
...
v=m(2)+1;
w=m(3)+1;
% first we rotate around w to null element (v,u) with respect to element (!vw,u) of vb_rotation matrix
g=2*mod(u-v,3)-3;
...
r(x(5:6))=-q(x(7:8));
q2=c*q-s*r;
% next we rotate around v to null element (!uv,u) with repect to element (u,u) of vb_rotation matrix
ss2=-g*q2(9-u-v)*q2(u)+q2(v)*q2(1);     % always off-diagonal
cc2=q2(1)^2+q2(u)^2-0.5;     % always on-diagonal
[s2,c2,rr,t2]=vb_atan2sc(ss2,cc2);
x2=y(v-1,:);
r2=zeros(4,1);
r2(x2(1:2))=q2(x2(3:4));
r2(x2(5:6))=-q2(x2(7:8));
