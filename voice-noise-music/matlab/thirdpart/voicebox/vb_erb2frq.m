function frq = vb_erb2frq(erb)
%vb_erb2frq  Convert ERB frequency scale to Hertz FRQ=(ERB)
%	frq = vb_erb2frq(erb) converts a vector of ERB-rate values
...
%      Version: $Id: vb_erb2frq.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
