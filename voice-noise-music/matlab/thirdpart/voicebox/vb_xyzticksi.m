function s=vb_xyzticksi(ax,ah)
%XYZTIXKSI labels an axis of a plot using SI multipliers S=(AX,AH)
%
% This routine is not intended to be called directly. See vb_xticksi and vb_yticksi.

%	   Copyright (C) Mike Brookes 2009
%      Version: $Id: vb_xyzticksi.m,v 1.1 2009/07/26 18:17:17 dmb Exp $
%
