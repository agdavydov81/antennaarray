function [y,fs,h]=vb_readcnx(filename,mode)
%vb_readcnx  Read a .CNX format sound file [Y,FS,H]=(FILENAME)
%
% Inputs:
...
%      Version: $Id: vb_readcnx.m,v 1.4 2007/05/04 07:01:39 dmb Exp $
%
