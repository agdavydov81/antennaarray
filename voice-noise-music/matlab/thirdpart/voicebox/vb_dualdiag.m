function [a,d]=vb_dualdiag(w,b)
%vb_dualdiag Simultaneous diagonalisation of two hermitian matrices [A,D]=(W,B)
...
% If we then take A=vb_dualdiag(W,B) and postmultiply all our original data vectors by A, we obtain new
...
%      Version: $Id: vb_dualdiag.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
