function [a,f,B,W]=vb_ldatrace(b,w,n,c)
%vb_ldatrace Calculates an LDA transform to maximize trace discriminant [a,f,B,W]=(b,w,n,c)
...
%      Version: $Id: vb_ldatrace.m,v 1.7 2007/05/04 07:01:38 dmb Exp $
%
