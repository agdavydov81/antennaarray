function [y,fs]=vb_readflac(filename,mode)
%vb_readwav  Read a .FLAC format sound file [Y,FS]=(FILENAME,MODE)
%
% Input Parameters:
%
...
%      Version: $Id: vb_readflac.m,v 1.1 2009/09/13 15:52:23 dmb Exp $
%
...
doscom=['"' vb_voicebox('flac') '"' ' -d -f -o "' filetemp '" "' filename '"'];
