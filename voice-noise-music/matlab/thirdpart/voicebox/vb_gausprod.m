function [g,u,k]=vb_gausprod(m,c,e)
%vb_gausprod calculates a product of gaussians [G,U,K]=(M,C)
...
%      Version: $Id: vb_gausprod.m,v 1.5 2007/05/04 07:01:38 dmb Exp $
%
...
[d,n]=size(m);
if nargin>2
    error('third argument not yet implemented in vb_gausprod');
end
