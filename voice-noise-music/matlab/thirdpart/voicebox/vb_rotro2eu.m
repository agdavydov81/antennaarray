function e=vb_rotro2eu(m,ro)
%ROTQR2EQ converts a 3x3 vb_rotation matrix into the corresponding euler angles
% Inputs: 
%
%     M(1,3)   a string of 3 characters from the set {'x','y','z'} e.g. "zxz" or "zyx"
%              or, equivalently, a vector whose elements are 1, 2 or 3
%     RO(3,3)  3x3 vb_rotation matrix
%
% Outputs:
%
%     E(3,1)   3 euler angles in the range +-pi
%
% The string M specifies the axes (fixed in space) about which the vb_rotations of
...
%      Version: $Id: vb_rotro2eu.m,v 1.2 2007/11/23 18:47:46 dmb Exp $
%
...
[s,c,r,e(3)]=vb_atan2sc(h*ro(v,u),ro(6-v-w,u));
r2=ro;
ix=1+mod(w+(0:1),3);
r2(ix,:)=[c s; -s c]*ro(ix,:);
