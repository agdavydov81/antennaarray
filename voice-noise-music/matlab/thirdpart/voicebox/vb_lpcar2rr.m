function rr=vb_lpcar2rr(ar,p)
%vb_lpcar2rr Convert autoregressive coefficients to autocorrelation coefficients RR=(AR,P)
...
%      Version: $Id: vb_lpcar2rr.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
...
if size(ar,2)==1
   ...
   if nargin>1
      rr=vb_lpcrf2rr(vb_lpcar2rf(ar),p).*k(:,ones(1,p+1));
   else
      rr=vb_lpcrf2rr(vb_lpcar2rf(ar)).*k(:,ones(1,size(ar,2)));
   end
end
