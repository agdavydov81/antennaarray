function [ar,arp,aru,g]=vb_lpcrf2ar(rf)
%vb_lpcrf2ar Convert reflection coefs to autoregressive coefs [AR,ARP,ARU,G]=(RF)
%
...
%      Version: $Id: vb_lpcrf2ar.m,v 1.5 2007/05/04 07:01:39 dmb Exp $
%
