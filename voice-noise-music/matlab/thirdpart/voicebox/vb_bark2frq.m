function f = vb_bark2frq(b)
%vb_bark2frq  Convert the BARK frequency scale to Hertz FRQ=(BARK)
%       frq = vb_bark2frq(bark) converts a vector of frequencies (in BARK)
...
%      Version: $Id: vb_bark2frq.m,v 1.2 2007/05/04 07:01:38 dmb Exp $
%
