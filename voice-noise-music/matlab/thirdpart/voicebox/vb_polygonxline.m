function [xc,ec,tc,xy0]=vb_polygonxline(p,l)
%vb_polygonxline Find where a line crosses a polygon [xc,ec,tc,xy0]=(p,l)
% Inputs
...
%      Version: $Id: vb_polygonxline.m,v 1.1 2009/04/07 19:23:53 dmb Exp $
%
