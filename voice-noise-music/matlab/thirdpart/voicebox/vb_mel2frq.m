function frq = vb_mel2frq(mel)
%vb_mel2frq  Convert Mel frequency scale to Hertz FRQ=(MEL)
%	frq = vb_mel2frq(mel) converts a vector of Mel frequencies
...
%      Version: $Id: vb_mel2frq.m,v 1.4 2007/05/04 07:01:39 dmb Exp $
%
