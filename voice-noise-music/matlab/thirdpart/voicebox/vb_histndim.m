function [v,t]=vb_histndim(x,b,mode)
%vb_histndim - generates and/or plots an n-dimensional histogram
%
...
%
% Example: vb_histndim(randn(100000,2),[20 -3 3]','pz');

%	   Copyright (C) Mike Brookes 2004
%      Version: $Id: vb_histndim.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
