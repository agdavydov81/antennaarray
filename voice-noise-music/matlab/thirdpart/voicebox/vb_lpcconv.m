function s=vb_lpcconv(from,to,x,y,np)
%vb_lpcconv(from,to,x,y)->s convert between LPC parameter sets
%
...
%      Version: $Id: vb_lpcconv.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
