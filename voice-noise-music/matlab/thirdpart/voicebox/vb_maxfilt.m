function [y,k,y0]=vb_maxfilt(x,f,n,d,x0)
%vb_maxfilt find max of an exponentially weighted sliding window  [Y,K,Y0]=(X,F,N,D,X0)
%
...
%         Y0  Last N-1 values (used to initialize a subsequent call to vb_maxfilt())
%
...
% w=4;m=100;x=rand(m,1);[y,k]=vb_maxfilt(x,1,2*w+1);p=find(((1:m)-k)==w);plot(1:m,x,'-',p-w,x(p-w),'+')

%      Copyright (C) Mike Brookes 2003
%      Version: $Id: vb_maxfilt.m,v 1.7 2008/06/02 08:11:45 dmb Exp $
%
