function y=vb_zoomfft(x,n,m,s,d)
%vb_zoomfft    DFT evaluated over a linear frequency range Y=(X,N,M,S,D)
% Inputs:
%    x    vector (or matrix)
...
% Thus vb_zoomfft(x,n,n,0,d) is equivalent to fft(x,n,d) for n>=length(x).
...
%      Version: $Id: vb_zoomfft.m,v 1.3 2007/11/21 12:42:36 dmb Exp $
%
