function u=vb_lpcifilt(s,ar,t,dc,fade)
%vb_lpcifilt Apply inverse filter to speech signal U=(S,AR,T,DC,FADE)
%
...
%      [lpar,lpe,lpk]=vb_lpcauto(spp,lpcord,floor([0.01 0.02]*fs)); % 20ms frame with 10ms frame increment
%      overlap=k(1,2)-k(2,1)+1;                     % overlap between adjacent frames
%      u=vb_lpcifilt(sp,ar,k(:,1)+floor(overlap/2),0,overlap/4);  % do inverse filtering

%      Copyright (C) Mike Brookes 1997
%      Version: $Id: vb_lpcifilt.m,v 1.5 2007/07/18 17:41:49 dmb Exp $
%
