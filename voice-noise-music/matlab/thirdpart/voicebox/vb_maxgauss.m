function [u,v,p,r] = vb_maxgauss(m,c,d)
%vb_maxgauss determine gaussian approximation to max of a gaussian vector [p,u,v,r]=(m,c,d)
%
% Inputs:
...
%      Version: $Id: vb_maxgauss.m,v 1.5 2008/07/07 11:42:53 dmb Exp $
%
