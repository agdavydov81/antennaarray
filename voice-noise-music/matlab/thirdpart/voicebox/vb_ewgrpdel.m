function [y,mm]=vb_ewgrpdel(x,w,m)
%vb_ewgrpdel calculates the energy weighted group delay waveform Y=(X,W,M)
...
% Example: x=zeros(1000,1); x(100:100:900)=1; vb_ewgrpdel(x,99);

%	   Copyright (C) Mike Brookes 2003
%      Version: $Id: vb_ewgrpdel.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
