function d=vb_distchpf(pf1,pf2,mode)
%vb_distchpf calculates the cosh spectral distance between power spectra D=(PF1,PF2,MODE)
%
...
%
% The COSH distance is a symmetrical version of the Itakura-Saito distance: vb_distchpf(x,y)=(vb_distispf(x,y)+vb_distispf(y,x))/2
...
%      Version: $Id: vb_distchpf.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
