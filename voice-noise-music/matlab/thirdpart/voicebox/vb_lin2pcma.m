function p=vb_lin2pcma(x,m,s)
%vb_lin2pcma Convert linear PCM to A-law P=(X,M,S)
%	pcma = vb_lin2pcma(lin) where lin contains a vector
...
%
%	See also vb_pcma2lin, vb_lin2pcma, vb_lin2pcmu



%      Copyright (C) Mike Brookes 1998
%      Version: $Id: vb_lin2pcma.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
