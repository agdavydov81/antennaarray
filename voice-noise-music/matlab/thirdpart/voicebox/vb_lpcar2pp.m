function pp=vb_lpcar2pp(ar)
%vb_lpcar2pp LPC: Convert ar filter to power spectrum polynomial in cos(w) PP=(AR)
% the pp is a polynomial such that |polyval(ar,e^jw)|^2 = polyval(pp,cos(w))

%      Copyright (C) Mike Brookes 1998
%      Version: $Id: vb_lpcar2pp.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
