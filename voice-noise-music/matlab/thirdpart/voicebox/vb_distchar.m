function d=vb_distchar(ar1,ar2,mode)
%vb_distchar calculates the cosh spectral distance between AR coefficients D=(AR1,AR2,MODE)
%
...
% The COSH distance is a symmetrical version of the Itakura-Saito distance: vb_distchar(x,y)=(vb_distisar(x,y)+vb_distisar(y,x))/2
...
%
%         np=255; d0=vb_distchar(ar1,ar2); d1=vb_distchpf(vb_lpcar2pf(ar1,np),vb_lpcar2pf(ar2,np))
%
...
%      Version: $Id: vb_distchar.m,v 1.4 2007/05/04 07:01:38 dmb Exp $
%
...
m1=zeros(nf1,2*p1);
m2=zeros(nf2,2*p1);
m1(:,1:p1)=vb_lpcar2rr(ar1);
m1(:,p2:end)=vb_lpcar2ra(ar1);
m1(:,1)=m1(:,1)*0.5;
m1(:,p2)=m1(:,p1+1)*0.5;
m2(:,p2:end)=vb_lpcar2rr(ar2);
m2(:,1:p1)=vb_lpcar2ra(ar2);
