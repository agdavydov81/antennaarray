function q=vb_roteu2qr(m,t)
%vb_roteu2qr converts a sequence of euler angles to a real unit quaternion
% Inputs:
%
%     M(1,n)   a string of n characters from the set {'x','y','z'}
%              or, equivalently, a vector whose elements are 1, 2, or 3
%     T(1,n)   n vb_rotation angles
%
% Outputs:
%
...
% possibilities. Common ones are "ZXZ" and "ZYX". A positive vb_rotation is clockwise
...
%      Version: $Id: vb_roteu2qr.m,v 1.2 2007/11/21 12:42:36 dmb Exp $
%
...
% and t gives the vb_rotation angles in radians
q=[1 0 0 0]';
if ischar(m)
    m=lower(m)-'w';
end
