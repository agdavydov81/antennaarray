function [x,zo]=vb_overlapadd(f,win,inc)
%vb_overlapadd join overlapping frames together X=(F,WIN,INC)
%
...
%      Version: $Id: vb_overlapadd.m,v 1.2 2009/06/08 16:21:49 dmb Exp $
%
