function [y,eql] = rm_postaud(x,fmax,fbtype,broaden)
%y = rm_postaud(x, fmax, fbtype)
%
...
if strcmp(fbtype, 'bark')
  bandcfhz = rm_bark2hz(linspace(0, rm_hz2bark(fmax), nfpts));
elseif strcmp(fbtype, 'mel')
  bandcfhz = rm_mel2hz(linspace(0, rm_hz2mel(fmax), nfpts));
elseif strcmp(fbtype, 'htkmel') || strcmp(fbtype, 'fcmel')
  bandcfhz = rm_mel2hz(linspace(0, rm_hz2mel(fmax,1), nfpts),1);
else
