function [spec,wts,iwts] = rm_invaudspec(aspectrum, sr, nfft, fbtype, minfreq, maxfreq, sumpower, bwidth)
%pspectrum = rm_invaudspec(aspectrum, sr, nfft, fbtype, minfreq, maxfreq, sumpower, bwidth)
%
% Invert (as best we can) the effects of rm_audspec()
%
...
elseif strcmp(fbtype, 'fcmel')
  wts = rm_fft2melmx(nfft, sr, nfilts, bwidth, minfreq, maxfreq, 1);
else
