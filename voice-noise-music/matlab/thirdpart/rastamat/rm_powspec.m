function y = rm_powspec(x, sr, wintime, steptime, dither)
%y = rm_powspec(x, sr, wintime, steptime, sumlin, dither)
%
...
% I think this doesn't quite make sense, but it's what rasta/rm_powspec.c does
