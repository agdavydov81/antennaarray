...
handles.config0 = struct('debug_messages',0, 'debug_msgbox',0, 'debug_saveframes',0, 'debug_ignore_emi',0, 'password','');
...
if handles.press_ok
	...
	cfg.debug_ignore_emi = handles.config.debug_ignore_emi;
